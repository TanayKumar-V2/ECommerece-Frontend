...
export default function ResetPasswordEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Reset your Viraasat account password</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={heroBand}>
            <Text style={heroLabel}>PASSWORD RESET</Text>
            <Heading style={heroTitle}>Forgot your password?</Heading>
          </Section>

          <Section style={contentSection}>
            <Text style={greeting}>Hi {name},</Text>
            <Text style={bodyText}>
              We received a request to reset the password for your Viraasat
